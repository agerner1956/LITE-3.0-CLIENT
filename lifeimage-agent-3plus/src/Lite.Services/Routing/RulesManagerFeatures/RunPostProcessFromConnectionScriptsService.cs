...
namespace Lite.Services.Routing.RulesManagerFeatures
{
    ...
    /// </summary>
    public interface IRunPostProcessFromConnectionScriptsService
    {
        /// <summary>
        /// RunPostProcessFromConnectionScripts is intended to be run once for the fromConnection after outbound processing.
        /// </summary>
        Task RunPostProcessFromConnectionScripts(Rules Item, RoutedItem routedItem);
    }

    public sealed class RunPostProcessFromConnectionScriptsService : IRunPostProcessFromConnectionScriptsService
    {
        private readonly IScriptService _scriptService;
        private readonly ILogger _logger;

        public RunPostProcessFromConnectionScriptsService(
            IScriptService scriptService,
            ILogger<RunPostProcessFromConnectionScriptsService> logger)
        {
        ...
        /// <returns></returns>
        public async Task RunPostProcessFromConnectionScripts(Rules Item, RoutedItem routedItem)
        {
            Throw.IfNull(Item);
            ...
            try
            {
                ...
                foreach (var destRule in destRulesToProcess)
                {
                    ...
                    foreach (var scriptname in destRule.postProcessFromConnectionScriptNames)
                    {
