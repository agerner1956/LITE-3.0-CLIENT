...
namespace Lite.Services.Routing.RouteItemManager
{
    ...
    /// </summary>
    public interface IDequeueBlockingCollectionService
    {
        /// <summary>
        /// Dequeue removes RoutedItem metadata and related file artifact(s) from disk and from a specified connection and list
        /// </summary>
        void Dequeue(RoutedItem Item, Connection conn, BlockingCollection<RoutedItem> list, string queueName, Stream stream, bool error = false);
    }

    public sealed class DequeueBlockingCollectionService : RouteItemHandler, IDequeueBlockingCollectionService
    {
        ...
        public void Dequeue(RoutedItem Item, Connection conn, BlockingCollection<RoutedItem> list, string queueName, Stream stream, bool error = false)
        {
