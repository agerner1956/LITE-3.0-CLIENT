...
namespace Lite.Services.Routing.RouteItemManager
{
    ...
    /// </summary>
    public interface IEnqueueBlockingCollectionService
    {
        /// <summary>
        /// Enqueue serializes and adds a RoutedItem metadata and related file artifact(s) to a specified connection and list
        /// </summary>
        void Enqueue(RoutedItem Item, Connection conn, BlockingCollection<RoutedItem> list, string queueName, bool copy = false);
    }

    public sealed class EnqueueBlockingCollectionService : RouteItemHandler, IEnqueueBlockingCollectionService
    {
