...
#pragma warning disable 1998
        [HttpDelete("{boxUuid}/{fileID}", Name = "DeleteFile")]
        public async Task<ActionResult> Delete(string boxUuid, string fileID)
        {
        ...
        [HttpGet("{boxUuid}/{fileID}", Name = "GetFile")]
