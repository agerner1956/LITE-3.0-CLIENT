    ...
    public class SetupController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create()
        {
            try
            {
                ...
                var liteManager = _connectionManagerFactory.GetManager(connection) as ILiteConnectionManager;
                await liteManager.RegisterLITE(profile);

                return CreatedAtRoute("GetLITE", new { username = connection.username }, profile);
